...
//			soundFx.volume = 0;
	...
	{
		Instance.PlaySound(Instance.musicsGame, Instance.musicAudio);
	}

	public static void PlayPauseMusic()
	{
		Instance.PlaySound(Instance.pauseMusic, Instance.musicAudio);
	}
	public static void PlayQuizMusic()
	{
		Instance.PlaySound(Instance.quizeMusic, Instance.musicAudio);
	}

	public static void StopMusic()
	{
		if (Instance.musicAudio == null)
		{
			return;
		}
