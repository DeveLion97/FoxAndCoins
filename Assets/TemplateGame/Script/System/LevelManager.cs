...
//	public CheckPoint DebugSpawn;
	...
	void Start () {
        ...
        foreach (var _listener in listener) {
            ...
            // Recupera il nome dell'oggetto che contiene la listener
            string listenerObjectName = ((MonoBehaviour)_listener).gameObject.name;
            Debug.LogError("Oggetto con listener: " + listenerObjectName);
